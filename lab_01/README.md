...
Перед запуском сервера и клиента необходимо сгенерировать вспомогательные файлы из контракта [`auth_service.proto`](auth_service.proto). Это делается командой:
