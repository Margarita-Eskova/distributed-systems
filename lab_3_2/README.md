...
Финальная симуляция проведена на **500 узлах** с **20% потерь пакетов** и **20% отказавших узлов**.  
Это сделано намеренно, чтобы:
- Замедлить конвергенцию и позволить расписанию Fanout (2→5→8→4→3) проявиться на графиках.
- Проверить устойчивость gossip-протокола в условиях высокой нагрузки и нестабильной сети.

Даже в таких условиях конвергенция достигнута за **7 секунд**, что подтверждает эффективность адаптивной настройки параметров.
